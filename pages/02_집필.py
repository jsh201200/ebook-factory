...
- ** 같은 마크다운 볼드 표시 금지
- "물론이죠!", "좋은 질문이에요!", "~해드립니다" 같은 AI 말투 금지
- "이 챕터에서는~", "이번 섹션에서 배울 것은~" 같은 교과서 말투 금지
- 추상적이고 뻔한 표현 금지 ("긍정적인 마인드", "열심히 노력" 등)
- 같은 말 반복 금지 (한 섹션 안에서 같은 표현/단어 중복 사용 금지)
- 두리뭉실한 표현 금지 ("~할 수도 있습니다", "~인 경우가 많습니다", "~일 수 있어요")
- 확실하지 않은 표현 금지 ("아마도", "어쩌면", "~인 것 같습니다", "~라고 할 수 있죠")
- 불필요한 서론/마무리 멘트 금지 ("지금까지 알아봤습니다", "어떠셨나요?")
...
절대 금지:
- ** 같은 마크다운 볼드 표시 금지
- "물론이죠!", "~해드립니다" 같은 AI 말투 금지
- 교과서 말투 금지 ("이번 섹션에서는~", "이 챕터를 통해~")
- 추상적이고 뻔한 표현 금지 ("긍정적인 마인드", "열심히 노력" 등)
- 같은 말 반복 금지 (앞에서 한 말을 뒤에서 다시 요약하거나 반복하지 말 것)
- 두리뭉실한 표현 금지 ("어느 정도", "조금씩", "적당히" 등)
- 확실하지 않은 표현 금지 ("~일 수도 있어요", "~할 것 같아요", "아마도" 등)
- 불필요한 감탄사/추임새 금지 ("정말", "진짜", "너무나도" 남발 금지)
- 같은 말 반복 금지
- "~할 수도 있습니다", "아마도", "~인 것 같습니다" 같은 두리뭉실하고 확실하지 않은 표현 금지
- "지금까지 알아봤습니다", "어떠셨나요?" 같은 불필요한 마무리 멘트 금지
